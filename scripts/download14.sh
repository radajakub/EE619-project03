...
sshpass -p MFoRL2645 scp -r 20236065@eelabg14.kaist.ac.kr:EE619-project03/MINE/ee619/trained_model_intermediate.pt ~/Projects/EE619-project03/outputs/newest_14/trained_model_intermediate.pt
